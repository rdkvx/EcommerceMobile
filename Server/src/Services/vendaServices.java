...
public class vendaServices {
    ...
    public String trataEnvio(ArrayList<Entities.venda> produtos, int opte) throws IOException{
    ...
    public String relatorioVendas(ArrayList<Entities.venda> produtos){
      float total = 0;
      for(int i = 0; i<produtos.size(); i++){
    ...
    public String cadastroProduto(Entities.produto produto , ArrayList<Entities.venda> vendas,  ArrayList<Entities.venda> produtos) throws IOException{
         Entities.venda vnd = new Entities.venda();
        ...
        try{
            ...
            Entities.venda vnd1temp = new Entities.venda();
