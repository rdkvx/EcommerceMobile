...
import com.example.javae_commerceconsole.databinding.ActivityListProdBinding;
...
public class ListProd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_content_list_prod);
